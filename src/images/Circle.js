...
const Circle = ({
    ...
    switch (size) {
        ...
        case 50:
            return (
                <svg width={size} height={size} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" >
                    <g id="circle50" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        ...
        default:
            return (
                <svg width={size} height={size} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" >
                    <g id="circle60" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
